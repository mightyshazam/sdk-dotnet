...
namespace Temporal.WorkflowClient
{
    public class TemporalClientConfiguration
    {
        ...
        /// <summary>
        /// Factory gets the `IWorkflowChain` for wich the converter is to be used;
        /// and returns a new non-null data converter to be applied to ALL calls made by the client constructued with this config.
        /// </summary>
        public Func<IWorkflowChain, IDataConverter> DataConverterFactory { get; init; }

        /// <summary>
        /// Factory gets the `IWorkflowChain` for which the interceptors are being constructed and list of all
        /// already existing interceptors, i.e. the interceptors generated by the system. That interceptor list
        /// is never null, but may be empty. The interceptor list does NOT include the final "sink" interceptor
        /// - it will always remain LAST and the factory shall not be able to affect that. However, the list DOES
