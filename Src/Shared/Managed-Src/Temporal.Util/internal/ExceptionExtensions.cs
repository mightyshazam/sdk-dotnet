...
namespace Temporal.Util
{
    ...
    {
        /// <summary>
        /// <c>ExceptionDispatchInfo.Capture(exception).Throw()</c> produces more informative stack traces when rethrowing exceptions.
        /// This method rethrows the specified exception using <c>ExceptionDispatchInfo</c>.
        /// It is typed to return the exception, to enable writing concise code like:
        /// <code>
        ///   try
        ///   {
        ///       // ...
